...
// const Intro = () => {
//   return (
//     <div className='flex flex-wrap items-start mt-36'>
//       <div className='relative blur '></div>
//       <div>
...
//         <button
//           className='p-3 mt-10 text-white rounded-full shadow-lg bg-yellow px-7 shadow-orange'>
//           Hire me
//         </button>
//         <div className='relative flex gap-9 top-20'>
